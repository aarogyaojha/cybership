# RateLane Frontend Dashboard

This is the user-facing dashboard for RateLane, built to demonstrate a premium integration with the backend capability engine.
...
_(Make sure to update `BACKEND_URL` and `NEXT_PUBLIC_APP_URL` if you are running on custom ports)._
